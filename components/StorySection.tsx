    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 max-w-7xl w-full text-center">
                <p className="text-[4vw] md:text-[3.5vw] font-bold leading-[1.1] font-space tracking-tight text-black uppercase opacity-90 hover:opacity-100 transition-opacity duration-500">
